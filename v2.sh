# !/bin/bash
# Author 		: Gau Sendiri
# Thanks to 		: Allah SWT - Orang Tua - Teman teman - Gua senditi
# Recode tinggal recode aja okeh, tapi cantumin source lah tolol
# Yamaap kalau scriptnya acak"an maklum masih belajar:(
...
echo -e '''
      ...
      \e[1;37m *Tools Jangan Diperjual belikan ya asw  !
   \e[1;37m[\e[1;31m Blog \e[1;31m:\e[1;34m https://blog.github.com\wedusganteng\e[1;37m ]
